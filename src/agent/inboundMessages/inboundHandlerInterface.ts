...
export const SignatureDecorator = Record({
    "@type": Union(Literal("https://didcomm.org/signature/1.0/ed25519Sha512_single"), Literal("did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/signature/1.0/ed25519Sha512_single")),
    signature: String,
    sig_data: String,
    signer: String
})
