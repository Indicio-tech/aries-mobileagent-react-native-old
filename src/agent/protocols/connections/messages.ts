import {Static, Record, String, Literal, Array, Union, Undefined, Partial} from 'runtypes'
...
export const ConnectionRequest = Record({
    "@type": Union(Literal("https://didcomm.org/connections/1.0/request"), Literal("did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/connections/1.0/request")),
    "@id": MessageID,
    label: String,
    connection:Record({
        DID:DID,
...
export const ConnectionResponse = Record({
    "@type": Union(Literal("https://didcomm.org/connections/1.0/response"), Literal("did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/connections/1.0/response")),
    "@id": MessageID,
    connection:Record({
        DID:DID,
        DIDDoc: DIDDoc
