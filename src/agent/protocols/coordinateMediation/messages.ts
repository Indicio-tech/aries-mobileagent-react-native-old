import {Static, Record, String, Literal, Boolean, Union, Partial, Array } from 'runtypes'
import { MessageID } from '../baseMessage'

//Mediate Request
export const MediateRequestMessage = Record({
    "@type": Union(Literal("https://didcomm.org/coordinate-mediation/1.0/mediate-request"), Literal("did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/coordinate-mediation/1.0/mediate-request")),
    "@id": MessageID,
...
export const MediateDenyMessage = Record({
    "@type": Union(Literal("https://didcomm.org/coordinate-mediation/1.0/deny"), Literal("did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/")),
    "@id": MessageID,
    mediator_terms: Array(String),
    recipient_terms: Array(String)
})
...
export const MediateGrantMessage = Record({
    "@type": Union(Literal("https://didcomm.org/coordinate-mediation/1.0/mediate-grant"), Literal("did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/coordinate-mediation/1.0/mediate-grant")),
    "@id": MessageID,
    endpoint: String,
...
export const KeylistUpdateMessage = Record({
    "@type": Union(Literal("https://didcomm.org/coordinate-mediation/1.0/keylist-update"), Literal("did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/coordinate-mediation/1.0/keylist-update")),
    "@id": MessageID,
...
export const KeylistUpdateResponse = Record({
    "@type": Union(Literal("https://didcomm.org/coordinate-mediation/1.0/keylist-update-response"), Literal("did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/coordinate-mediation/1.0/keylist-update-response")),
    "@id": MessageID,
