...
export const PingMessage = Record({
  '@type': Union(
    Literal('https://didcomm.org/trust_ping/1.0/ping'),
    Literal('did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/trust_ping/1.0/ping'),
  ),
  '@id': MessageID,
...
export const PingResponseMessage = Record({
  '@type': Union(
    Literal('https://didcomm.org/trust_ping/1.0/ping_response'),
    Literal('did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/trust_ping/1.0/ping_response'),
  ),
  '@id': MessageID,
  '~timing': Record({}), //TODO: Define timing decorator
  comment: String,
