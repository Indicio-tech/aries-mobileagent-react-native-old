...
class TrustPingHandler
  extends BaseProtocolHandler
  implements TrustPingHandlerInterface {
  messageCallbacks = {
    'did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/trust_ping/1.0/ping_response': this.receiveResponse.bind(
      this,
    ),
  }
  ...
  async receiveResponse(
    ...
    throw new Error(
      'Received unexpected trust ping response, handling not implemented',
    )
  }
}
